...
const PublicacaoScreen = () => {
  ...
  const handleTextoChange = (texto) => {
    setTexto(texto);
    setContador(1000 - texto.length); // Atualiza o contador de caracteres restantes
  };

  const handlePublicar = () => {
    // Implemente a lógica de publicação aqui, por exemplo, enviar o texto para um servidor
  ...
  return (
    <View style={styles.container}>
      <TextInput
        ...
        value={texto}
        maxLength={1000} // Define o limite de caracteres
      />
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    padding: 10,
    marginBottom: 10,
    minHeight: 100, // Altura mínima do TextInput
  },
  contador: {
    alignSelf: 'flex-end',
    marginBottom: 10,
